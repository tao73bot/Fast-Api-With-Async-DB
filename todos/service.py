...
class TodoService:
    async def get_all_todos(self,db: AsyncSession = get_db(),current_user = Depends(get_current_user)):
        async with db as session:
